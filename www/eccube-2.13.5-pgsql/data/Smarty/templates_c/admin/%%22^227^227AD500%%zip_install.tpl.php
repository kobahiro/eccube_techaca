<?php /* Smarty version 2.6.27, created on 2017-03-02 18:06:13
         compiled from basis/zip_install.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'basis/zip_install.tpl', 25, false),array('modifier', 'strlen', 'basis/zip_install.tpl', 25, false),array('modifier', 'count', 'basis/zip_install.tpl', 25, false),array('modifier', 'h', 'basis/zip_install.tpl', 32, false),array('modifier', 'default', 'basis/zip_install.tpl', 57, false),)), $this); ?>
...
" />
 ...
 行のデータがあります。</p>
        <?php if (((is_array($_tmp=$this->_tpl_vars['tpl_line'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) == 0): ?>
            <p class="attention">郵便番号CSVを取得してください。</p>
        <?php elseif (((is_array($_tmp=$this->_tpl_vars['tpl_count_mtb_zip'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) == 0): ?>
...
" size="8" /><span class="attention"><?php echo ((is_array($_tmp=$this->_tpl_vars['arrErr']['startRowNum'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
        ...
        <div class="basis-zip-item">
            ...
            <?php else: ?>
                ...
                <p><a class="btn-normal" href="javascript:;" onclick="eccube.setModeAndSubmit('update_csv', '', ''); return false;"><span class="btn-next">更新</span></a><span class="attention"><?php echo ((is_array($_tmp=$this->_tpl_vars['arrErr']['startRowNum'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
</span></p>
            <?php endif; ?>
        </div>
