<?php /* Smarty version 2.6.27, created on 2017-03-02 17:35:49
         compiled from products/confirm.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'products/confirm.tpl', 26, false),array('modifier', 'h', 'products/confirm.tpl', 31, false),array('modifier', 'sfTrim', 'products/confirm.tpl', 64, false),array('modifier', 'default', 'products/confirm.tpl', 167, false),array('modifier', 'nl2br', 'products/confirm.tpl', 191, false),array('modifier', 'nl2br_html', 'products/confirm.tpl', 203, false),array('modifier', 'function_exists', 'products/confirm.tpl', 235, false),array('modifier', 'strlen', 'products/confirm.tpl', 282, false),array('modifier', 'sfNoImageMainList', 'products/confirm.tpl', 283, false),)), $this); ?>
...
?>
                    <?php if (((is_array($_tmp=$this->_tpl_vars['status'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) != ""): ?>
                        <img src="<?php echo ((is_array($_tmp=$this->_tpl_vars['TPL_URLPATH_PC'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
...
">
        ...
        <?php if (((is_array($_tmp=$this->_tpl_vars['arrForm']['has_product_class'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) != true): ?>
            ...
            <?php if (((is_array($_tmp=$this->_tpl_vars['arrForm']['product_type_id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) == PRODUCT_TYPE_DOWNLOAD): ?>
            <tr>
                <th>ダウンロード商品ファイル名</th>
                <td>
 ...
 円<?php endif; ?>
            ...
            <tr>
                <th>消費税率</th>
                <td>
                    <?php if (strlen ( ((is_array($_tmp=$this->_tpl_vars['arrForm']['tax_rate'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) ) >= 1): ?><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arrForm']['tax_rate'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('h', true, $_tmp) : smarty_modifier_h($_tmp)); ?>
 %<?php endif; ?>
                </td>
            </tr>
            <?php endif; ?>
