<?php /* Smarty version 2.6.27, created on 2017-02-07 18:34:09
...
" />
                    <input type="radio" name="indexflag_new[<?php echo ((is_array($_tmp=$this->_sections['cnt']['iteration'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
]" value="1" <?php if (((is_array($_tmp=$this->_tpl_vars['arrForm'][$this->_sections['cnt']['index']]['indexflag'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) == '1'): ?>checked="checked"<?php endif; ?> />
                </td>
...
]" value="" <?php if (((is_array($_tmp=$this->_tpl_vars['arrForm'][$this->_sections['cnt']['index']]['indexflag'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) != '1'): ?>checked="checked"<?php endif; ?> /></td>
