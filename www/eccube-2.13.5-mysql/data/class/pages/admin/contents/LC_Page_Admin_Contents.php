...
class LC_Page_Admin_Contents extends LC_Page_Admin_Ex
{
    ...
    public function action()
    {
        ...
        switch ($this->getMode()) {
            ...
            case 'pre_edit':
                ...
                list($news['end_year'],$news['end_month'],$news['end_day']) = $this->splitNewsDate($news['cast_end_date']);     //変更
    ...
    public function lfCheckError(&$objFormParam)
    {
        ...
        $objErr->doFunc(array('表示終了期限', 'end_year', 'end_month', 'end_day'), array('CHECK_DATE'));      //変更
        $objErr->doFunc(array('日付', '表示終了期限', 'year', 'month', 'day', 'end_year', 'end_month', 'end_day'), array('CHECK_SET_TERM'));        //変更
    ...
    public function lfInitParam(&$objFormParam)
    {
        ...
        $objFormParam->addParam('表示終了期限(年)', 'end_year', INT_LEN, 'n', array('EXIST_CHECK', 'NUM_CHECK', 'MAX_LENGTH_CHECK'));      //変更↓
    ...
    public function doRegist($news_id, $sqlval, SC_Helper_News_Ex $objNews)
    {
        ...
        $sqlval['end_date'] = $this->getEndDate($sqlval);       //変更
        unset($sqlval['end_year'], $sqlval['end_month'], $sqlval['end_day']);       //変更
